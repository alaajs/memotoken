...
send_msg(msg.to.id, " 🏌 اشتركو بالقناه🔞 كلها شغلات خاصه 🔞  ☂\n\n🔹https://t.me/joinchat/AAAAAEAo-QxlZdlf4x6SGw",nil, 'html')
...
if string.match(ww, 'ميمو')  or  string.match(ww, 'ميمو') or  string.match(ww, 'ميمو') or  string.match(ww, 'ميمو')  or string.match(ww, 'ميمو') then
return true
else
return false
end
...
----------------------------------------------
if is_sudo(msg) and w == "ميمو" and not ww then 
return  su[math.random(#su)]  
elseif not is_sudo(msg) and w == "ميمو" and not ww then 
...
elseif w== "بوت"  then
return  "😌😌لا تبقه اتمسلت كول شتريد من صحت بوت 🌪 🌚🌸"
...
elseif w == "بوت اضحك" and ww and msg.reply_id and is_sudo(msg) then
if msg.reply_id then
